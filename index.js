...
const examinerGuard = require("./middleware/examinerGuard");
...
//G2 Portal route
app.get("/g2", authGuard, g2RouteController);
//G Portal route
app.get("/g", authGuard, gRouteController);
//Login route
...
//Update G
app.post("/gUpdate", authGuard, gFormController);
//Save G2 Details
app.post("/g2Save", authGuard, g2FormController);
//Create Appointment
